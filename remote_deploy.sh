...
pssh -t0 -Px '-A -tt' -H "$MACHINES" "sudo mv /home/zhangjiguo/tmux-master /usr/local"
pssh -t0 -Px '-A -tt' -H "$MACHINES" "sudo mv /home/zhangjiguo/zsh-master /usr/local"
pssh -t0 -Px '-A -tt' -H "$MACHINES" "sudo mv /home/zhangjiguo/vim-8.0.0599 /usr/local"
